...
class RemoveAccessPinScreen extends StatefulWidget {
  const RemoveAccessPinScreen({super.key});

  @override
  _RemoveAccessPinScreenState createState() => _RemoveAccessPinScreenState();
}

class _RemoveAccessPinScreenState extends State<RemoveAccessPinScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: (){
                Get.toNamed(AppRoutes.oldAccessPinScreen);
              },
              child: Row(

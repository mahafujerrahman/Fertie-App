...
class NewAccessPinScreen extends StatefulWidget {
  const NewAccessPinScreen({super.key});

  @override
  _NewAccessPinScreenState createState() => _NewAccessPinScreenState();
}

class _NewAccessPinScreenState extends State<NewAccessPinScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: (){
                Get.toNamed(AppRoutes.confirmAccessPinScreen);
              },
              child: Row(

...
class AppColors{
  ...
  static Color bottomBarColor = const Color(0xFF1397D5);
  ...
  static Color colorEDFBFF = const Color(0xFFEDFBFF);
  static Color redColor = const Color(0xFFFC6057);
  static Color popUpColor = const Color(0xFF222633);
  static Color color8DB501 = const Color(0xFF8DB501);
  static Color newOrderColor = const Color(0xFF00A4EA);
  static Color color12618B = const Color(0xFF12618B);
  static Color greenColor = const Color(0xFF00A967);
  static Color color4B4B4B = const Color(0xFF4B4B4B);
  static Color colorReview = const Color(0xFFFFD33C);
  static Color color59a35f = const Color(0xFF59a35f);
